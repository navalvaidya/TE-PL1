...
<div class="container">
		...
		while(result.next())
	{
		%>	
		 <tr>
		 <td><a href="/jsp/DeleteController.jsp?id=<%=result.getString("id") %>"><%=result.getString("id") %></a></td>
		  <td><a href="/jsp/DeleteController.jsp?id=<%=result.getString("id") %>"><%=result.getString("name") %></a></td>
		 </tr>
		<% 		
	}
		%>
